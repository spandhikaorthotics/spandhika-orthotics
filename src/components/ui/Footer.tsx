...
export default function Footer() {
  ...
  async function onSubmit(e: FormEvent) {
    e.preventDefault();
    if (!email || loading || !token) {
      if (!token) setErrorMessage("Please complete the security check.");
      return;
    }
              ...
              <form onSubmit={onSubmit} className="flex flex-col gap-2.5">
                ...
                <div className="mt-0.5">
                  <Turnstile
                    ...
                    onError={() => setErrorMessage("Security verification failed. Please refresh.")}
                    theme="dark"
                  />
                </div>
